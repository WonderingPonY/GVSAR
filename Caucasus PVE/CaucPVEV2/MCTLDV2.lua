...
--Anti Air
my_ctld:AddCratesCargo("Patriot Large 6",{"BLUE SAM PatriotLarge"},CTLD_CARGO.Enum.FOB,6,400,nil,"Anti-Air")
my_ctld:AddCratesCargo("Rapier site 1",{"BLUE SAM Rapier Site"},CTLD_CARGO.Enum.FOB,4,400,nil,"Anti-Air")
my_ctld:AddCratesCargo("Linebacker PLT",{"Linebacker"},CTLD_CARGO.Enum.VEHICLE,3,400,nil,"Anti-Air")
...
my_ctld:AddCratesCargo("EWR",{"BLUE EWR"},CTLD_CARGO.Enum.VEHICLE,2,400,nil,"Anti-Air")
