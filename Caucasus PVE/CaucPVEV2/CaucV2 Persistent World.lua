...
function writemission(data, file)--Function for saving to file (commonly found)
	File = io.open(("C:\\Users\\Gracey's Village DCS\\Saved Games\\DCS.test_server\\Persistent Files\\"..file), "w")
	File:write(data)
	File:close()
end
...
--////LOAD UNITS
if file_exists("C:\\Users\\Gracey's Village DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugUnitInterment.lua") then

	dofile("C:\\Users\\Gracey's Village DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugUnitInterment.lua")
...
--////Static units
if file_exists("C:\\Users\\Gracey's Village DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugStaticInterment.lua") then

	dofile("C:\\Users\\Gracey's Village DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugStaticInterment.lua")
...
--////LOAD AIRBASES
if file_exists("C:\\Users\\Gracey's Village DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugAirbases.lua") then

	dofile("C:\\Users\\Gracey's Village DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugAirbases.lua")
