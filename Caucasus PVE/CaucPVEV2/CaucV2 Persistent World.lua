...
function writemission(data, file)--Function for saving to file (commonly found)
	File = io.open(("S:\\Users\\Graceys-Village-DCS\\Saved Games\\DCS.test_server\\Persistent Files\\"..file), "w")
	File:write(data)
	File:close()
end
...
--////LOAD UNITS
if file_exists("S:\\Users\\Graceys-Village-DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugUnitInterment.lua") then

	dofile("S:\\Users\\Graceys-Village-DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugUnitInterment.lua")
...
--////Static units
if file_exists("S:\\Users\\Graceys-Village-DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugStaticInterment.lua") then

	dofile("S:\\Users\\Graceys-Village-DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugStaticInterment.lua")
...
--////LOAD AIRBASES
if file_exists("S:\\Users\\Graceys-Village-DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugAirbases.lua") then

	dofile("S:\\Users\\Graceys-Village-DCS\\Saved Games\\DCS.test_server\\Persistent Files\\SeaSlugAirbases.lua")
