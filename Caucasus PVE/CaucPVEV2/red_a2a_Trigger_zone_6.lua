...
DetectionSetGroup:FilterPrefixes( { "RED EWR" } )
...
-- Squadron 1
A2ADispatcher:SetSquadron( "Sq 1", AIRBASE.Caucasus.Beslan, { "SFighterMiG29" }, 100 )
...
A2ADispatcher:SetSquadronTakeoffFromParkingHot("Sq 1")
A2ADispatcher:SetSquadronLandingNearAirbase( "Sq 1" , "Kutaisi")
...
--Squadron 2
 A2ADispatcher:SetSquadron( "Sq 2", AIRBASE.Caucasus.Kutaisi, { "ReconFighterMig21" }, 100 )
 ...
 A2ADispatcher:SetSquadronTakeoffFromParkingHot("Sq 2")
 A2ADispatcher:SetSquadronLandingNearAirbase( "Sq 2" , "Kutaisi")
...
--A2ADispatcher:SetSquadronLanding( "Sq 2" , "Kutaisi")
--Squadron 3
