...
my_ctld:AddCratesCargo("Forward Ops Base (4)",{"FOB"},CTLD_CARGO.Enum.FOB,4)
...
my_ctld:AddCratesCargo("MBT Merkava (4)",{"Merkava"},CTLD_CARGO.Enum.VEHICLE,4)
my_ctld:AddCratesCargo("TPz Fuchs (2)",{"TPzFuchs"},CTLD_CARGO.Enum.VEHICLE,2)
my_ctld:AddCratesCargo("Paladin (4)",{"Paladin"},CTLD_CARGO.Enum.VEHICLE,4)
my_ctld:AddCratesCargo("Patriot (6)",{"ISRAELPATRIOT"},CTLD_CARGO.Enum.VEHICLE,6)
...
my_ctld:AddCratesRepair("FOB Repair (1)","FOB",CTLD_CARGO.Enum.REPAIR,1)
