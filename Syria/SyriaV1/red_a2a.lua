...
A2ADispatcher:SetSquadronLandingNearAirbase( "Sq 1" , "Palmyra")
...
A2ADispatcher:SetSquadronLandingNearAirbase( "Sq 2" , "Palmyra")
...
A2ADispatcher:SetSquadronLandingNearAirbase( "Sq 3" , "Sayqal")
