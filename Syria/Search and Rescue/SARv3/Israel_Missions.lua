...
function missionsIsrael(zonename,groupName)
    ...
    elseif (zonename == "IsraelMission13") then
        coalition.addGroup(80,2,Mission13) --Adds the Group for the mission
        coalition.addStaticObject(80,Mission13Scenery) --Adds the Group for the mission
        --trigger.action.effectSmokeBig(zone.point,3,1,"IsraelMission9-Smoke") -- Adds smoke on the zone center
    ...
    elseif (zonename == "IsraelMission14") then
        coalition.addGroup(80,2,Mission14) --Adds the Group for the mission
        coalition.addGroup(80,2,Mission14Scenery) --Adds the Group for the mission
        --trigger.action.effectSmokeBig(zone.point,3,1,"IsraelMission9-Smoke") -- Adds smoke on the zone center
    ...
    elseif (zonename == "IsraelMission15") then
        coalition.addGroup(80,2,Mission15) --Adds the Group for the mission
        coalition.addGroup(80,2,Mission15Scenery) --Adds the Group for the mission
        --trigger.action.effectSmokeBig(zone.point,3,1,"IsraelMission9-Smoke") -- Adds smoke on the zone center
    ...
    elseif (zonename == "IsraelMission16") then
        coalition.addGroup(80,2,Mission16) --Adds the Group for the mission
        coalition.addGroup(80,2,Mission16Scenery) --Adds the Group for the mission
        --trigger.action.effectSmokeBig(zone.point,3,1,"IsraelMission9-Smoke") -- Adds smoke on the zone center
    ...
    elseif (zonename == "IsraelMission17") then
      ...
      IsraelMission17Smoke3.y = land.getHeight( {x =IsraelMission17Smoke3.x, y = IsraelMission17Smoke3.z} )
        coalition.addGroup(80,2,Mission17) --Adds the Group for the mission
        coalition.addGroup(80,2,Mission17Scenery) --Adds the Group for the mission
    ...
    elseif (zonename == "IsraelMission18") then
        coalition.addGroup(80,2,Mission18) --Adds the Group for the mission
        coalition.addGroup(80,2,Mission18Scenery) --Adds the Group for the mission
        --trigger.action.effectSmokeBig(zone.point,3,1,"IsraelMission9-Smoke") -- Adds smoke on the zone center
    ...
    elseif (zonename == "IsraelMission19") then
        coalition.addGroup(80,2,Mission19) --Adds the Group for the mission
    ...
    elseif (zonename == "IsraelMission20") then
        coalition.addGroup(80,2,Mission20) --Adds the Group for the mission
        coalition.addGroup(80,2,Mission20Scenery) --Adds the Group for the mission
        --trigger.action.effectSmokeBig(zone.point,3,1,"IsraelMission9-Smoke") -- Adds smoke on the zone center
    ...
    elseif (zonename == "IsraelMission21") then
        coalition.addGroup(80,2,Mission21) --Adds the Group for the mission
        coalition.addGroup(80,2,Mission21Scenery) --Adds the Group for the mission
        --trigger.action.effectSmokeBig(zone.point,3,1,"IsraelMission9-Smoke") -- Adds smoke on the zone center
    ...
    elseif (zonename == "IsraelMission22") then
        coalition.addGroup(80,2,Mission22) --Adds the Group for the mission
        coalition.addGroup(80,2,Mission22Scenery) --Adds the Group for the mission
        --trigger.action.effectSmokeBig(zone.point,3,1,"IsraelMission9-Smoke") -- Adds smoke on the zone center
    ...
    elseif (zonename == "IsraelMission23") then
        ...
        coalition.addGroup(80,2,Mission23) --Adds the Group for the mission
        coalition.addGroup(80,2,Mission23Scenery) --Adds the Group for the mission
    ...
    elseif (zonename == "IsraelMission24") then
        coalition.addGroup(80,2,Mission24) --Adds the Group for the mission
        coalition.addGroup(80,2,Mission24Scenery) --Adds the Group for the mission
        --trigger.action.effectSmokeBig(IsraelMission23Smoke,1,1,"IsraelMission23-Smoke") -- Adds smoke on the zone center
