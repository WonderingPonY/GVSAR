...
BlueRecceSetGroup = SET_GROUP:New():FilterCoalitions("blue"):FilterPrefixes( {"JTAC"} ):FilterStart()
--RedRecceSetGroup = SET_GROUP:New():FilterCoalitions("red"):FilterPrefixes( {"Reece Red"} ):FilterStart()

BLUE_CAS_Set = SET_GROUP:New():FilterPrefixes( {"Senaki", "WP1", "WP2", "WP3", "WP4"} ):FilterStart()
