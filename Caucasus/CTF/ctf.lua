...
CTF.RedBase = {x=CTF.RedBaseUnitPos.x, z=CTF.RedBaseUnitPos.z, y=CTF.RedBaseUnitPos.y + 50}
-- Blue base location in game-world (Vec3) position format:
CTF.BlueBase = {x=CTF.BlueBaseUnitPos.x, z=CTF.BlueBaseUnitPos.z, y=CTF.BlueBaseUnitPos.y + 50}
