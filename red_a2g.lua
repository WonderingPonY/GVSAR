...
A2GDispatcher:SetSquadronSeadPatrolInterval( "Marj SEAD", 2, 30, 60, 1 )
...
A2GDispatcher:SetSquadronCasPatrolInterval( "Marj CAS", 2, 30, 60, 1 )
...
A2GDispatcher:SetSquadronCasPatrolInterval( "Khalkhalah CAS", 2, 30, 60, 1 )
...
A2GDispatcher:SetSquadronBaiPatrolInterval( "Khalkhalah BAI", 5, 30, 60, 1 )
