...
my_ctld:AddCratesCargo("Rapier site 1",{"Rapier Site"},CTLD_CARGO.Enum.VEHICLE,1,400,nil,"Anti-Air")
my_ctld:AddCratesCargo("Gepard PLT 3",{"Gepard PLT"},CTLD_CARGO.Enum.VEHICLE,3,400,nil,"Anti-Air")
my_ctld:AddCratesCargo("Avenger PLT 3",{"Avenger PLT"},CTLD_CARGO.Enum.VEHICLE,3,400,nil,"Anti-Air")
